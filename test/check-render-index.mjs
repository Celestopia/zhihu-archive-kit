...
assert.match(html, /data-collection-filter="all" aria-pressed="true" title="所有"/);
...
assert.match(html, /data-collection-filter="默认收藏夹" aria-pressed="false" title="默认收藏夹"/);
assert.match(html, /data-collection-filter="空收藏夹" aria-pressed="false" title="空收藏夹"/);
