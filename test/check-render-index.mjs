...
assert.match(html, /data-collection-filter="all" data-collection-description="全部收藏夹内容" aria-pressed="true" title="所有"/);
...
assert.match(html, /data-collection-filter="默认收藏夹" data-collection-description="暂无收藏夹描述" aria-pressed="false" title="默认收藏夹"/);
assert.match(html, /data-collection-filter="技术收藏" data-collection-description="技术类内容" aria-pressed="false" title="技术类内容"/);
assert.match(html, /data-collection-filter="空收藏夹" data-collection-description="暂无收藏夹描述" aria-pressed="false" title="空收藏夹"/);
